...
export const Hero = () => {
  return (
    <div className="w-full h-[50vh] sm:h-[50vh] md:h-[70vh] grid sm:grid-cols-2 items-center">
      ...
      <div className="sm:w-[380px] lg:w-[600px] gap-5 mt-10 text-center sm:text-start col-span-1">
        <h2 className="text-8xl sm:text-8xl lg:text-9xl font-extrabold text-[#a87b05]">NEREA</h2>
        ...
        <Link to="/products" className="bg-[#2e8b57] text-white p-3 rounded-lg  lg:mt-10 font-bold">Ver productos</Link>
      </div>
    </div>
  )
}
