  ...
  return (
    <nav className="bg-gray-100 flex px-4 py-3 sm:py-5 md:px-20 lg:px-40 justify-between items-center sticky top-0 border-b-2 z-50">
      <div className="flex gap-4 sm:gap-7 items-center text-[1.1rem]">
        <Link
          to="/"
          className="flex items-center border-2 rounded-[50%] p-1 border-black"
        >
        ...
        <Link
          to="/products"
          className={` ${
            pathname === "/products" ? "relative link-style" : ""
          } hidden sm:block font-semibold uppercase tracking-widest`}
        >
          Ver Catalago
        </Link>
      </div>
      ...
      <div className="hidden sm:flex sm:items-center gap-5 ">
        <Link
          to="/about"
          className="border-[2px] border-[#2e8b57] hover:bg-[#23613e] hover:text-white p-2 rounded-2xl font-semibold"
        >
          Quienes Somos
        </Link>
        <Link
          to="/contact"
          className=" bg-[#2e8b57] hover:bg-[#23613e] p-[10px] rounded-2xl font-semibold flex items-center gap-2"
        >
