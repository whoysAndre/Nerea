...
export const Hero = () => {
  return (
    <div className="w-full h-[50vh] sm:h-[80vh] grid sm:grid-cols-2 items-center">
      ...
      <div className="sm:w-[600px]  gap-5 mt-10 text-center sm:text-start">
        ...
        <Link to="/products" className="bg-[#2e8b57] text-white p-3 rounded-lg mt-10 font-bold">Ver productos</Link>
      </div>
    </div>
  )
}
